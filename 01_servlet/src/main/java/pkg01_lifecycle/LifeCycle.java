 ...
 */
  ...
  *     (2) WEB-INF/web.xml에 필요한 코드를 수정하여 할 수 있다.        
  */
...
public class LifeCycle extends HttpServlet {
	 ...
	 * 
	 * service()
	 * 1. 클라이언트로부터 요청을 받을 수 있다. (매개변수 HttpServletRequest request)*중요
	 * 2. 클라이언트에게 응답할 수 있다.        (매개변수 HttpServletResponse response)*중요
	 * 3. service() 메소드가 있으면 여기서 요청과 응답을 해결한다.
	 * 4. service() 메소드가 없으면 doGET() 또는 doPost() 가 요청에 따라 호출된다.
	 */ 
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
	  System.out.println("servive() 메소드 호출");
