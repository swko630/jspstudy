...
/* 
 *  view - [filter] - controller - service - dao - db (데이터는 순차적으로 전달된다)
 */
...
public class BoardServiceImpl implements BoardService {
  ...
  public ActionForward getBoardByNo(HttpServletRequest request) {
    ...
    String view = null;     
    if(board != null) {
      view = "/board/detail.jsp";  // forward는 request에 저장하고 .jsp로 보낸다.
  ...
  @Override
  public ActionForward editBoard(HttpServletRequest request) { // 값을 가지고 편집화면으로 넘어가는 메소드
