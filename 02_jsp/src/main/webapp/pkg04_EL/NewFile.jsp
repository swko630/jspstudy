...
<%--  
   ...
   2. Bind 영역에 저장된 값을 나타낼 수 있다. - Bind 영역에 저장해야 사용할 수 있다.
...
<% int a = 10; request.setAttribute("a", a);%> <%-- bind 영역에 저장하여 값이 나타난다. --%>
...
<body>
 ...
 %>
 <div>${book.title}</div>  <%-- book.getTitle() 방식으로 알아서 호출된다. --%>
...
<%
 List<Book> books = Arrays.asList(
     new Book("태백산맥", "조정래",10000),
     new Book("홍길동전", "허균",5000),
