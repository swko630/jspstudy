 ...
 * 5. @AfterAll  : JUnit Test Case(BoardTset.java) 실행 이후에 동작하는 메소드 (static 처리)
 * 
 */
...
public class BoardTest {
  ...
  public void 목록개수테스트() {
    ...
    assertEquals(500, total); // total == 500 이면 테스트 성공
  ...
  public void 목록테스트() {
    ...
    List<BoardDto> boadList = boardDao.selectBoardList(params);
    
    assertEquals(20, boadList.size());
